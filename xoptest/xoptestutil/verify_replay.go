	...
	want.SpanMetadata.Map.Range(func(k string, wantM *xopbaseutil.MetadataTracker) bool {
		...
		if assert.Equal(t, wantM.Type.String(), gotM.Type.String(), "metadata type derived from ZZZ in MetadataZZZ") {
			...
			case xopbase.AnyArrayDataType:
				verifyMetadataArray(t, k, wantM.Value, gotM.Value, verifyMetadataAny)
			case xopbase.AnyDataType:
				verifyMetadataAny(t, k, wantM.Value, gotM.Value)
			case xopbase.EnumArrayDataType:
				verifyMetadataArray(t, k, wantM.Value, gotM.Value, verifyMetadataEnum)
			case xopbase.EnumDataType:
				verifyMetadataEnum(t, k, wantM.Value, gotM.Value)
			case xopbase.LinkArrayDataType:
				verifyMetadataArray(t, k, wantM.Value, gotM.Value, verifyMetadataLink)
			case xopbase.LinkDataType:
				verifyMetadataLink(t, k, wantM.Value, gotM.Value)
			case xopbase.TimeArrayDataType:
				verifyMetadataArray(t, k, wantM.Value, gotM.Value, verifyMetadataTime)
			case xopbase.TimeDataType:
				verifyMetadataTime(t, k, wantM.Value, gotM.Value)
