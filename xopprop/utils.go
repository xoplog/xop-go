...
func SetByTraceParentHeader(s *xoplog.Seed, h string) {
...
func SetByB3Header(s *xoplog.Seed, h string) {
	switch h {
	case "0", "1":
		SetByB3Sampled(s, h)
		return
...
// X-B3-Sampled
func SetByB3Sampled(s *xoplog.Seed, h string) {
	switch h {
	case "1":
...
func SetByB3ParentSpanId(s *xoplog.Seed, h string) {
